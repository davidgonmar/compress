...
def main():
    ...
    p.add_argument("--prog_dir",   required=True,
                   help="dir of progressive JSONs (lsq_p8-4-2_s*.json)")
    p.add_argument("--static_dir", required=True,
                   help="dir of static    JSONs (lsq_w2a2_s*.json)")
    p.add_argument("--out_pdf",    default="lsq_compare_full.pdf",
