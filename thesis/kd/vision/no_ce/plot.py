...
def main():
    parser = argparse.ArgumentParser(description="Plot training run results and save to PDF")
    parser.add_argument('-i', '--input', required=True, help='Path to JSON result file')
    parser.add_argument('-o', '--output', default='training_plot.pdf', help='Output PDF file')
